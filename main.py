...
def main():
    ...
    parser.add_argument("--scrape-contacts", action="store_true", help="Scrape contacts list")
    parser.add_argument("--limit", type=int, default=50, help="Limit number of items to scrape")
